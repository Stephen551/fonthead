...
// A&C addition: expose to global scope so a Web Worker's importScripts()
// or a classic <script> tag in the main thread can pick this up without
// a CommonJS loader. Original `module.exports` assignment above stays
// intact for Node/bundler consumers; we just mirror it onto self/window.
if (typeof self !== 'undefined') self.cubic2quad = module.exports;
